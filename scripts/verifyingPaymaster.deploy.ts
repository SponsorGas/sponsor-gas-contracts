...
async function main() {
  ...
  const verifyingPaymaster =  VerifyingPaymasterArtifacts.attach("0xd6F6bA8025366300822Dae5008762074bC72F1B5") //0xe6e61b4cb54ecfc67421b61bcdc5a566d91888ae -( base paymaster)
  ...
  console.log(`Verfiying Paymaster Address: ${verifyingPaymaster.address}`)
	...
	// await entryPoint.depositTo(verifyingPaymaster.address, { value: parseEther('1'),maxFeePerGas: 10e10  });
